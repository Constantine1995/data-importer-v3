...
use App\Jobs\ReplicateServices\ReplicateIncomesJob;
use App\Models\Account;
use Carbon\Carbon;
use App\Console\Commands\BaseCommand;

class ReplicateIncomesToAccounts extends BaseCommand
{
    protected $signature = 'replicate:incomes {--date-from=} {--date-to=}';
    protected $description = 'Duplicates data from Incomes to IncomesAccounts for all accounts';
    ...
    protected function handleValidated(array $validatedArguments)
    {
        ...
        foreach (Account::cursor() as $account) {
            ...
            ReplicateIncomesJob::dispatch($account->id, $dateFrom, $dateTo);
            $this->info("Task dispatched to Job for account: $account->name, Service: Incomes");
        }
