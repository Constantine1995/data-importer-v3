...
use App\Jobs\ReplicateServices\ReplicateOrdersJob;
use App\Models\Account;
use Carbon\Carbon;
use App\Console\Commands\BaseCommand;

class ReplicateOrdersToAccounts extends BaseCommand
{
    protected $signature = 'replicate:orders {--date-from=} {--date-to=}';
    protected $description = 'Duplicates data from Orders to OrdersAccounts for all accounts';
    ...
    protected function handleValidated(array $validatedArguments)
    {
        ...
        foreach (Account::cursor() as $account) {
            ...
            ReplicateOrdersJob::dispatch($account->id, $dateFrom, $dateTo);
            $this->info("Task dispatched to Job for account: $account->name, Service: Orders");
        }
